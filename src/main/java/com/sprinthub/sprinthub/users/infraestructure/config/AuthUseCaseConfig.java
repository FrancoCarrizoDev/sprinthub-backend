...
public class AuthUseCaseConfig {
    ...
    @Bean CreateNewUserUseCase createNewUserUseCase(UserRepository userRepository, UserMapper userMapper) {
        return new CreateNewUserUseCase(userRepository, userMapper);
    }
